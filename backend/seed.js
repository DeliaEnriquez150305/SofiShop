...
const seedDB = async () => {
  try {
    ...
    const productosM = [
      ...
      { nombre: 'Good Girl', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 110, stock: 18, descripcion: 'Fragancia audaz y sofisticada', imagen: '/perfumes/carolina herrera/Good Girl 2.7 oz by Carolina Herrera For Women.png' },
      { nombre: 'Very Good Girl', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 100, stock: 20, descripcion: 'Versión suave y romántica', imagen: '/perfumes/carolina herrera/Very Good Girl Eau De Parfum 1.7 oz From Carolina Herrera For Women.png' },
      { nombre: '212 NYC', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 95, stock: 17, descripcion: 'Clásico moderno y elegante', imagen: '/perfumes/carolina herrera/212 NYC 2 oz by Carolina Herrera For Women.png' },
      { nombre: 'Good Girl Blush', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 105, stock: 19, descripcion: 'Deseo sin límites', imagen: '/perfumes/carolina herrera/Good Girl Blush 2.8 oz Eau De Parfum by Carolina Herrera for Women.png' },
      { nombre: 'Good Girl Bowtastic', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 115, stock: 16, descripcion: 'Glamour absoluto', imagen: '/perfumes/carolina herrera/CAROLINA HERRERA Good Girl Bowtastic 2.7oz EDP for Women.png' },
      { nombre: 'CH Pasion', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 100, stock: 21, descripcion: 'Elegancia femenina', imagen: '/perfumes/carolina herrera/CH Pasion by Carolina Herrera 3.4oz EDP Spray for WOMEN.png' },
      { nombre: 'La Bomba', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 110, stock: 19, descripcion: 'Heroísmo y valentía', imagen: '/perfumes/carolina herrera/La Bomba by Carolina Herrera 1oz EDP Spray for WOMEN.png' },
      { nombre: '5212 VIP Rose', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 120, stock: 15, descripcion: 'Esencia del lujo', imagen: '/perfumes/carolina herrera/5212 Vip Rose 2.7(Tester) oz by Carolina Herrera For Women 5.png' },
      { nombre: 'Carolina Herrera Elegante', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 105, stock: 18, descripcion: 'Elegancia suprema', imagen: '/perfumes/carolina herrera/Carolina Herrera 3.4 by Carolina Herrera For Women.png' },
      { nombre: 'Carolina Herrera Classic', marca: 'Carolina Herrera', categoria: 'perfumes', subcategoria: 'Mujer', precio: 95, stock: 22, descripcion: 'El clásico atemporal', imagen: '/perfumes/carolina herrera/Very Good Girl Glam .33 oz Eau De Parfum by Carolina Herrera for Women.png' },
      // KATHY PERRY MUJER (10)
      { nombre: 'Meow', marca: 'Kathy Perry', categoria: 'perfumes', subcategoria: 'Mujer', precio: 75, stock: 25, descripcion: 'Fragancia dulce y seductora', imagen: '/perfumes/katty/meow.png' },
      { nombre: 'Purr', marca: 'Kathy Perry', categoria: 'perfumes', subcategoria: 'Mujer', precio: 75, stock: 20, descripcion: 'Aroma sensual y misterioso', imagen: '/perfumes/katty/purr.png' },
      ...
      { nombre: 'Cloud', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 85, stock: 22, descripcion: 'Nube de felicidad', imagen: '/perfumes/cloud ariana.png' },
      { nombre: 'Cloud Pink', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 88, stock: 20, descripcion: 'Nube rosa romántica', imagen: '/perfumes/Cloud Pink by Ariana Grande 3.4 oz EDP for Women.png' },
      { nombre: 'Cloud 2.0 Intense', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 92, stock: 18, descripcion: 'Nube intensificada', imagen: '/perfumes/Cloud 2.0 Intense Eau De Parfum 3.4 oz From Ariana Grande For Women.png' },
      { nombre: 'God Is A Woman', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 90, stock: 19, descripcion: 'Poder femenino', imagen: '/perfumes/God Is A Woman 3.4 oz from Ariana Grande for Women.png' },
      { nombre: 'Mod Blush', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 87, stock: 21, descripcion: 'Sonrojo moderno', imagen: '/perfumes/mod blush.png' },
      { nombre: 'Mod Vanilla', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 86, stock: 23, descripcion: 'Vainilla moderna', imagen: '/perfumes/Mod Vanilla by Ariana Grande 3.4oz EDP Spray for WOMEN.png' },
      { nombre: 'R.E.M', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 89, stock: 17, descripcion: 'Rápido movimiento de ojos', imagen: '/perfumes/ariana.png' },
      { nombre: 'Moonlight', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 91, stock: 20, descripcion: 'Luz de luna', imagen: '/perfumes/moonlight.png' },
      { nombre: 'Sweet Like Candy', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 85, stock: 24, descripcion: 'Dulce como caramelo', imagen: '/perfumes/sweet.png' },
      { nombre: 'Cloud Body', marca: 'Ariana Grande', categoria: 'perfumes', subcategoria: 'Mujer', precio: 40, stock: 30, descripcion: 'Loción corporal nube', imagen: '/perfumes/Cloud Body.png' },
      ...
      { nombre: 'Obsession Woman', marca: 'Calvin Klein', categoria: 'perfumes', subcategoria: 'Mujer', precio: 100, stock: 19, descripcion: 'Obsesión femenina', imagen: '/perfumes/calvin klein/obesession.png' },
      { nombre: 'Euphoria Woman', marca: 'Calvin Klein', categoria: 'perfumes', subcategoria: 'Mujer', precio: 110, stock: 17, descripcion: 'Éxtasis para la mujer', imagen: '/perfumes/calvin klein/euphoria.png' },
      { nombre: 'Eternity Woman', marca: 'Calvin Klein', categoria: 'perfumes', subcategoria: 'Mujer', precio: 95, stock: 21, descripcion: 'Eternidad femenina', imagen: '/perfumes/calvin klein/eternity.png' },
      ...
      { nombre: 'Escape Woman', marca: 'Calvin Klein', categoria: 'perfumes', subcategoria: 'Mujer', precio: 88, stock: 22, descripcion: 'Escape femenino', imagen: '/perfumes/calvin klein/ecape.png' },
      { nombre: 'One', marca: 'Calvin Klein', categoria: 'perfumes', subcategoria: 'Mujer', precio: 98, stock: 19, descripcion: 'El número uno', imagen: '/perfumes/calvin klein/one.png' },
      { nombre: 'Moment', marca: 'Calvin Klein', categoria: 'perfumes', subcategoria: 'Mujer', precio: 102, stock: 18, descripcion: 'El momento perfecto', imagen: '/perfumes/calvin klein/moment.png' },
      ...
      { nombre: 'Calvin Klein Classic', marca: 'Calvin Klein', categoria: 'perfumes', subcategoria: 'Mujer', precio: 94, stock: 21, descripcion: 'El clásico de CK', imagen: '/perfumes/calvin klein/calvin.png' },
    ...
    const productosH = [
      // BHARARA HOMBRE (10)
      { nombre: 'Oud for Glory', marca: 'Bharara', categoria: 'perfumes', subcategoria: 'Hombre', precio: 140, stock: 10, descripcion: 'Perfume oriental y profundo', imagen: '/perfumes/hombre/Bharara/by.png' },
      { nombre: 'Manhattan', marca: 'Bharara', categoria: 'perfumes', subcategoria: 'Hombre', precio: 125, stock: 14, descripcion: 'Aroma urbano y cosmopolita', imagen: '/perfumes/hombre/Bharara/don.png' },
      { nombre: 'Royal Essence', marca: 'Bharara', categoria: 'perfumes', subcategoria: 'Hombre', precio: 135, stock: 12, descripcion: 'Esencia real y noble', imagen: '/perfumes/hombre/Bharara/chocolate.png' },
      { nombre: 'Heritage', marca: 'Bharara', categoria: 'perfumes', subcategoria: 'Hombre', precio: 130, stock: 13, descripcion: 'Herencia y tradición', imagen: '/perfumes/hombre/Bharara/double.png' },
      { nombre: 'Sultan', marca: 'Bharara', categoria: 'perfumes', subcategoria: 'Hombre', precio: 145, stock: 9, descripcion: 'Poder del sultán', imagen: '/perfumes/hombre/Bharara/edp.png' },
      ...
      { nombre: '1 Million', marca: 'Paco Rabanne', categoria: 'perfumes', subcategoria: 'Hombre', precio: 120, stock: 15, descripcion: 'Fragancia fresca y sensual para hombre', imagen: '/perfumes/hombre/Paco/million.png' },
      ...
      { nombre: 'Invictus', marca: 'Paco Rabanne', categoria: 'perfumes', subcategoria: 'Hombre', precio: 110, stock: 18, descripcion: 'Aroma deportivo y energético', imagen: '/perfumes/hombre/Paco/invictus.png' },
      { nombre: 'Xs Excess', marca: 'Paco Rabanne', categoria: 'perfumes', subcategoria: 'Hombre', precio: 100, stock: 20, descripcion: 'Fragancia intensa y aventurera', imagen: '/perfumes/hombre/Paco/black.png' },
      { nombre: 'Pour Homme', marca: 'Paco Rabanne', categoria: 'perfumes', subcategoria: 'Hombre', precio: 95, stock: 25, descripcion: 'Clásico elegante para hombre', imagen: '/perfumes/hombre/Paco/pour.png' },
      { nombre: 'Rabanito', marca: 'Paco Rabanne', categoria: 'perfumes', subcategoria: 'Hombre', precio: 115, stock: 16, descripcion: 'Aroma pequeño pero poderoso', imagen: '/perfumes/hombre/Paco/pacoo.png' },
